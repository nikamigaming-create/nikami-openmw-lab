...
namespace ESM
{
    ...
    enum RecNameInts : unsigned int
    {
        ...
        REC_AMEF4 = esm4Recname(ESM4::REC_AMEF), // Ammo Effect (Fallout: New Vegas)
        ...
        REC_RCCT4 = esm4Recname(ESM4::REC_RCCT), // Recipe category (Fallout: New Vegas)
        REC_RCPE4 = esm4Recname(ESM4::REC_RCPE), // Recipe (Fallout: New Vegas)

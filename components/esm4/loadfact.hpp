...
namespace ESM4
{
    ...
    // Fallout: New Vegas FACT data. FACT is reused by other Bethesda games;
    // ESMStore dispatches this typed schema only for Fallout versions.
    struct Faction
    {
        ...
        struct Data
        {
            ...
            std::array<std::uint8_t, Fallout::kFactionDataUnusedBytes> mUnused{};
...
#endif // OPENMW_COMPONENTS_ESM4_LOADFACT_H

...
void ESM4::Projectile::load(ESM4::Reader& reader)
{
    ...
    while (reader.getSubRecordHeader())
    {
        ...
        switch (subHdr.typeId)
        {
            ...
            case ESM::fourCC("NAM1"):
                mNameData1 = readRawSubrecord(reader, subHdr.dataSize);
                break;
            case ESM::fourCC("NAM2"):
                mNameData2 = readRawSubrecord(reader, subHdr.dataSize);
                break;
            ...
            case ESM::fourCC("DSTD"):
                mDestructibleData.push_back(readRawSubrecord(reader, subHdr.dataSize));
                break;
            case ESM::fourCC("DSTF"):
                reader.skipSubRecordData();
                break;
            default:
                throw std::runtime_error("ESM4::PROJ::load - Unknown subrecord " + ESM::printName(subHdr.typeId));
        }
    }
}

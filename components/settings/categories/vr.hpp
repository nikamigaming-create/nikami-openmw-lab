...
namespace Settings
{
    ...
    struct VRDebugCategory : WithIndex
    {
        ...
        SettingValue<bool> mDisableXR_KHR_opengl_es_enable{ mIndex, "VR Debug", "disable XR_KHR_opengl_es_enable" };
        SettingValue<bool> mDisableXR_KHR_android_create_instance{ mIndex, "VR Debug",
            "disable XR_KHR_android_create_instance" };

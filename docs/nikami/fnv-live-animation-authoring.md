...
- Latest full refreshed animation/build proof gate with Release build, refreshed T-pose, and refreshed live finger smoke passes every proof/build row: `D:\code\vulkanOpenMW\proof\fnv-live-animation-merge-gate\20260627_174523\merge-gate.json`.
- Current merge-readiness gate after fetching `origin` is intentionally red until this checkpoint is committed/shelved and the branch integrates current `origin/main`: `D:\code\vulkanOpenMW\proof\fnv-live-animation-merge-gate\20260627_182438\merge-gate.json`, `170 ahead / 2 behind`, failing `worktree-clean-for-merge-promotion` and `origin-main-integrated`; `origin-main-merge-conflict-forecast`, cached live-finger evidence, and cached T-pose evidence pass. The full refreshed build/live gate remains `20260627_174523`.
- Throwaway merge rehearsal committed this dirty checkpoint in `D:\code\vulkanOpenMW\proof\scratch\fnv-live-animation-merge-sandbox-20260627_175206`, merged `origin/main` cleanly into detached merge commit `e0bf2b6fcb`, and passed the post-merge Release build gate at `D:\code\vulkanOpenMW\proof\fnv-live-animation-merge-gate\20260627_175503\merge-gate.json` with `worktree-clean-for-merge-promotion=PASS`, `origin-main-integrated=PASS`, and `release-build-openmw=PASS`.
...
- Current strict live smoke artifact: `D:\code\vulkanOpenMW\proof\fnv-live-finger-closeup-sweep\20260627_174644\live-finger-closeup-sweep.json`, `Bip01 R Finger21`, `passCount=1`, `failCount=0`, `meanAbsDelta=76.531875160751028`, `changedPixels=2073600`, rigged hand consumption audited, live rig weight debug audited, `fabricNoTwistAuditLines=21`, and post-authoring fabric no-twist BAD count `0`.
- Fresh staticized T-pose bones/weights proof: `D:\code\vulkanOpenMW\proof\fnv-character-builder\20260627_174541_460_12728_53ae5264\character-builder-suite.json`, actorTarget `GSEasyPete`, actorKind `npc`, with visible hand geometry PASS, fabric no-twist BAD lines `0`, IK bone overlay proof lines, and staticized hand weight debug evidence accepted by the merge gate.

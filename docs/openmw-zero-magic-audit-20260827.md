...
the clean public lane through the current TERM format-owner slice. It does not rewrite unrelated
...
MGEF/SPEL actor-effect payload widths and offsets, and TERM model/data/script
payload widths and authored flag bounds. The LIP, CTDA, WTHR, CLMT, MGEF,
SPEL, and TERM decoders now consume those shared constants instead of

...
<<<<<<< HEAD
.. |bdg-ctx-load| replace:: :bdg-black:`load`
.. |bdg-ctx-non-load| replace:: :bdg-danger:`global` :bdg-warning:`menu` :bdg-info:`local`
.. |bdg-ctx-all| replace:: :bdg-danger:`global` :bdg-warning:`menu` :bdg-info:`local` :bdg-black:`load`
=======

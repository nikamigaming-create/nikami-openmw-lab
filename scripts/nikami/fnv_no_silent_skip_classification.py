...
LOADED_PENDING_RECORDS = {
    ...
    "QUST": "quest records are stored, QUST stage journal entries are bridged, selected stage fragments can execute, and objective displayed/completed script state is bound pending full quest execution/objective-target/condition parity",

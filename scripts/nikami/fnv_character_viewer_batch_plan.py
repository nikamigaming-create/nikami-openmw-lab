...
COMPONENT_PHASES = {
    ...
    "equipment-armor-model": ["equipment", "headgear"],
    "armor-addon-fnv-modl": ["equipment", "headgear"],
    "armor-addon-model": ["equipment", "headgear"],
    "equipment-clothing": ["equipment"],
    "equipment-clothing-model": ["equipment"],
    "equipment-weapon": ["weapon"],
    "equipment-weapon-model": ["weapon"],
    "equipment-weapon-reference": ["weapon"],

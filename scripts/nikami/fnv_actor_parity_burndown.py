...
PHASE_GATES: dict[str, list[dict[str, Any]]] = {
    "body": [
        ...
        {"gate": "standing-pose-family", "components": ["actor-base-record", "animation-kffz"], "states": ["idle"]},
        {"gate": "crouch-pose-family", "components": ["actor-base-record", "animation-kffz"], "states": ["crouch"]},
        {"gate": "kneel-pose-family", "components": ["actor-base-record", "animation-kffz"], "states": ["kneel"]},
        {"gate": "prone-pose-family", "components": ["actor-base-record", "animation-kffz"], "states": ["prone"]},
    ],
    "head": [
    ...
    "hair": [
        ...
        {"gate": "hair-under-headgear-policy", "components": ["hair", "equipment-armor", "equipment-armor-addon", "equipment-armor-model"], "states": ["neutral"]},
    ],
    "equipment": [
        {"gate": "outfit-inventory-resolution", "components": ["default-outfit", "sleep-outfit", "inventory-item", "equipment-armor", "equipment-clothing", "equipment-weapon"], "states": ["neutral"]},
        {"gate": "armor-addon-geometry", "components": ["equipment-armor", "equipment-armor-addon", "equipment-armor-model", "armor-addon-fnv-modl", "equipment-clothing", "equipment-clothing-model"], "states": ["neutral", "turn"]},
        {"gate": "biped-slot-visibility", "components": ["equipment-armor", "equipment-armor-addon", "equipment-armor-model", "armor-addon-fnv-modl"], "states": ["neutral"]},
    ],
    "weapon": [
        {"gate": "weapon-prop-attachment", "components": ["equipment-weapon", "equipment-weapon-model"], "states": ["weapon-draw", "attack"]},
        {"gate": "weapon-animation-family", "components": ["equipment-weapon", "equipment-weapon-model", "animation-kffz"], "states": ["attack", "reload"]},
        {"gate": "projectile-muzzle-sound", "components": ["equipment-weapon", "equipment-weapon-reference"], "states": ["projectile-fire"]},
        {"gate": "hand-weapon-transform", "components": ["equipment-weapon", "equipment-weapon-model"], "states": ["weapon-draw", "turn"]},
    ],
    "headgear": [
        {"gate": "headgear-slot-composition", "components": ["equipment-armor", "equipment-armor-addon", "equipment-armor-model", "armor-addon-fnv-modl"], "states": ["neutral"]},
        {"gate": "hat-hair-occlusion", "components": ["equipment-armor", "equipment-armor-addon", "equipment-armor-model", "armor-addon-fnv-modl", "hair"], "states": ["neutral", "turn"]},
        {"gate": "headgear-transform-pivot", "components": ["equipment-armor-addon", "equipment-armor-model", "armor-addon-fnv-modl"], "states": ["neutral", "turn"]},
    ],
    "talk": [

...
Assert-Text $npcAnimation "partRebuild=loaded-pending-runtime" "NPC actor-kit post-construction proof does not falsely claim full part rebuild support"
...
Assert-Text $liveActorKitPostConstructionProof "partRebuild=loaded-pending-runtime" "live actor-kit post-construction proof preserves pending rebuild classification"

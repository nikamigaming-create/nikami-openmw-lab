...
Assert-Text $npcAnimation "OPENMW_FNV_KEEP_UNSAFE_HAT_HAIR_VARIANT" "FONV unsafe covered hat hair has an explicit opt-out"
Assert-Text $npcAnimation "hair-under-headgear" "FONV unsafe covered hat hair opt-out is logged"

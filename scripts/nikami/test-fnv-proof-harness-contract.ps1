...
Assert-Text $characterViewerBundle '"actorKitSelection": raw.get("actorKitSelection")' "character viewer manifest preserves per-case actor-kit selector state"
...
Assert-Text $characterViewerBatchPlanner "no retail asset paths or payload bytes" "character viewer batch planner excludes retail asset payloads"

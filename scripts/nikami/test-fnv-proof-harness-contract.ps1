...
Assert-Text $npcAnimation "accounting NPC FaceGen source" "FONV head preserves race diffuse while accounting actor FaceGen source"
Assert-NoText $npcAnimation "applying NPC FaceGen diffuse" "FONV facemod source texture is not bound as final head diffuse"
...
Assert-Text $npcAnimation '"LOADED" : "MISSING"' "FONV face check reports whether actor FaceGen source was loaded"

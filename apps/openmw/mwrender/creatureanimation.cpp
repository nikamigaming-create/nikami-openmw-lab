    ...
    namespace
    {
        ...
        public:
            ...
            void apply(osg::Drawable& drawable) override
            {
                ...
                // RigGeometry is reparented under the live actor skeleton during attachment. The traversal path
                // above can still describe the detached body clone, so restore masks on the drawable's actual
                // skeleton path as well.

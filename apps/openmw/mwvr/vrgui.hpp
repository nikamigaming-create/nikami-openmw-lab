...
namespace MWVR
{
    ...
    public:
        ...
        /// Check wrist/compositor-style GUI quads directly from the controller ray.
        bool updateAndroidOpenXRQuadFocus(const Stereo::Pose& pointerPose, float* distanceMeters = nullptr);

        /// True if user is currently pointing at something
        bool hasFocus() const;

        /// True while a direct Android GUI ray hit is fresh enough for release-click activation.
        bool hasAndroidOpenXRQuadFocusLatch() const;
    ...
    private:
        ...
        osg::ref_ptr<VRGUILayer> mAndroidOpenXRQuadFocusLayer = nullptr;
        std::chrono::steady_clock::time_point mAndroidOpenXRQuadFocusUntil{};

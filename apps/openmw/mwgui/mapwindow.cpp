...
namespace
{
    ...
    std::string getFalloutWorldMapTexture()
    {
        ...
        return Misc::ResourceHelpers::correctTexturePath(
            VFS::Path::Normalized("textures\\interface\\worldmap\\wasteland_nv_1024_no_map.png"), *vfs);
    }
...
namespace MWGui
{
    ...
    MyGUI::Widget* MapWindow::createFalloutMapMarker(const ESM4::Reference& marker)
    {
        ...
        const std::string texture = Misc::ResourceHelpers::correctTexturePath(
            VFS::Path::Normalized(getFalloutMapMarkerIcon(marker.mMapMarkerType)), *vfs);

...
namespace MWGui
{
    ...
    void LoadingScreen::draw()
    {
        ...
        // This loading frame can run before default settings initialization.
        // Querying Settings::Manager here makes non-Fallout compatibility
        // viewers terminate before their world is created.

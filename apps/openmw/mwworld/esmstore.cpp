...
namespace MWWorld
{
    ...
    struct ESMStoreImp
    {
        ...
        static bool readRecord(ESM4::Reader& reader, ESMStore& store)
        {
            ...
            // AMEF, AVIF, EXPL, FACT, MESG, MGEF, PERK, RCCT, RCPE, SPEL, and NOTE are not cross-game schemas. These typed loaders
            ...
            if ((recordType == ESM4::REC_AMEF || recordType == ESM4::REC_AVIF || recordType == ESM4::REC_EXPL
                    || recordType == ESM4::REC_FACT || recordType == ESM4::REC_MESG

...
namespace MWWorld
{
    namespace
    {
        ...
        std::vector<std::pair<GlobalVariableName, ESM::Variant>> generateDefaultGlobals()
        {
            return {
                ...
                { Globals::sCharGenState, ESM::Variant(0) },
    ...
    float World::getTargetObject(MWRender::RenderingManager::RayResult& result, const osg::Vec3f& origin,
        const osg::Quat& orientation, float maxDistance, bool ignorePlayer, uint32_t ignoreMask)
    {
        osg::Vec3f direction = orientation * osg::Vec3f(0.f, 1.f, 0.f);
        ...
        ToUTF8::Utf8Encoder* encoder, Loading::Listener* listener)
    {
        ...
        ensureNeededRecords(); // Insert records that may not be present in all content sets.
    }

...
local configHUD = createDefaultConfig(0, true)
configHUD.extent = util.vector2(0.16, 0.065)
configHUD.center = util.vector2(0, 0.5)
configHUD.pixelsPerMeter = 1300
configHUD.space = 'LeftWristTop'
layerConfig.HUD = configHUD
...
local function updateSpacesSettings()
    ...
    configHUD.space = configHUD3D.space
    ...
    setLayerConfigIfNotOverridden('HUD', configHUD)
